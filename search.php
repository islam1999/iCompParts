...
<html lang="ru" dir="ltr">
	...
	<body>
		<div id="block-body">
          ...
          <?php if  (strlen($search) >= 3 && strlen($search) < 64) {
          ...
          ?>
				...
				<?php
								...
								$count=mysqli_query($link, "SELECT COUNT(*) FROM  table_products WHERE title LIKE '%$search%'");
                    ...
                    if ($temp[0]>0) {
                $result =  mysqli_query($link,"SELECT * FROM  table_products WHERE title LIKE '%$search%' LIMIT $start,$num");
                if(mysqli_num_rows($result) > 0) {
                  ...
                  echo "<center><p id>Ничего не найдено<p><center>";
                }
                }else {
                  include ("include/slider.php");
                  echo "<center><p id>Поисковое значение должно быть от 3 символов до 64<p><center>";
                }
            ?>
			</div>
